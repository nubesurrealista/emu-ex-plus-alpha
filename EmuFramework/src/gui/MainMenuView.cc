...
MainMenuView::MainMenuView(ViewAttachParams attach, bool customMenu):
	...
	{
		"Configuración de entrada en pantalla", attach,
		[this](const Input::Event &e)
		{
	...
	inputManager
	{
		"Configuración de teclado/mando", attach,
		[this](const Input::Event &e)
		{
	...
	scanWiimotes
	{
		"Escanear Wiimotes/iCP/JS1", attach,
		[this](const Input::Event &e)
		{
...
OptionCategoryView::OptionCategoryView(ViewAttachParams attach):
	...
	{
		{
			"Sincronización de cuadros", attach,
			[this](const Input::Event &e)
			{
	...
	}
{
	if(EmuApp::hasGooglePlayStoreFeatures())
	{
		...
		{
			"Salir o entrar de la beta", attach,
			[this]()
			{
